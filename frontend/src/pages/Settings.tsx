    ...
    const updateUser = async (e: { preventDefault: () => void; }) => {
        ...
        try {
            ...
            setMessage(
                err.response?.data?.error ||
                err.message ||
                "Prišlo je do napake pri posodabljanju uporbnikovih podatkov!"
            );
        }
    }
                ...
                <form onSubmit={updateUser} className='grid md:grid-cols-2 '>
                    ...
                    <div className="grid md:grid-cols-2  col-span-2 gap-3">
                        ...
                        <input
                            ...
                            onChange={handleChange}
                            type="text"
                            className="border border-gray-400 rounded-lg px-3 py-2 bg-gray-50 col-span-1 ml-3"
                        />
                        <button
                            type="submit"
